      ...
      <div class="row mt-3">
        <div class="mb-3 col-md-4">
          <label for="txtinternal"><?php echo _("Network interface") ;?></label>
            ...
            <input type="text" class="form-control ip_address" name="txtinternal" value="<?php echo $arrConfig['SocksPort']; ?>">
        </div>
      ...
      <div class="row">
        <div class="mb-3 col-md-6">
          <label for="txtpolicy"><?php echo _("Socks Policy") ;?></label>
            ...
            <input type="text" class="form-control" name="txtsockspolicy" value="<?php echo $arrConfig['SocksPolicy']; ?>">
        </div>
      </div>
      ...
      <div class="row">
        <div class="mb-3 col-md-6">
          ...
          <div class="form-check form-switch mt-1">
            <input class="form-check-input" id="chxdaemon" name="daemonmode" type="checkbox" value="1" checked disabled>
      ...
      <div class="row">
        <div class="mb-3 col-md-6">
          <label for="txtclientip"><?php echo _("Authentication method") ;?></label>
            ...
            <div class="form-check form-switch mt-1">
            <input class="form-check-input" id="chxcookieauth" name="cookieauth" type="checkbox" value="1" checked disabled>
